...
class CarModel {
    ...
    static void removeModel(Connection conn, int modelID) throws SQLException{
            ...
            if(ps.getUpdateCount()==0) {
                System.out.println("No Car Model found with the given ID");
            }
            else {
    ...
    static ResultSet getLatestModel(Connection conn, int brandID) throws SQLException{
            ...
            if (!rs.isBeforeFirst()) {    
                System.out.println("No Car Models found for the Brand");
            }
            while(rs.next()) {
                System.out.println();
                ...
                System.out.println("Average Mileage: "+rs.getFloat(5));
            }
            return rs;
    }
...
class Car {
    ...
    static ResultSet viewCarDetails(Connection conn, int carID) throws SQLException{
...
class Customer {
    ...
    static ResultSet viewCustomerDetails(Connection conn, int custID) throws SQLException{
...
class CustomerCar {
    ...
    static ResultSet viewCustomerCars(Connection conn, int custID) throws SQLException{
...
public class CarDealership {
    ...
    static final String DB_URL = "jdbc:postgresql://localhost:5432/carmanager?serverTimezone=UTC";
            ...
            while(true) {
                ...
                switch(choice) {
                    ...
                    case "11":
                        ...
                        break;
                    case "12":
                        System.out.println("Enter the Car Model's ID, and updated Generation and Mileage: ");
                        inp = sc.nextLine().split(" ");
                        CarModel.updateModel(conn, Integer.parseInt(inp[0]), Integer.parseInt(inp[1]), Integer.parseInt(inp[2]));
                        conn.commit();
                        break;
                    case "13":
                        System.out.println("Enter the Car's ID and updated colour: ");
                        inp = sc.nextLine().split(" ");
